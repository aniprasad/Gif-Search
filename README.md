Enter any gif you want to see into the text box and see randomized gifs based on that. This application uses the Giphy API to query gifs and simple JavaScript to render them to the user.
